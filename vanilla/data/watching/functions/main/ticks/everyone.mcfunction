#spottedCreeping
execute if entity @e[type=armor_stand,tag=creeping] unless entity @e[type=armor_stand,tag=spottedByPlayer] unless entity @s[gamemode=spectator] unless score @s crash matches 1.. anchored eyes facing entity @e[type=armor_stand,sort=nearest,limit=1,tag=spread] eyes anchored feet positioned ^ ^ ^1 rotated as @s positioned ^ ^ ^-1 if entity @s[distance=..0.85] anchored eyes facing entity @e[type=armor_stand,sort=nearest,limit=1,tag=spread] eyes positioned ^ ^ ^ run function watching:events/sightings/spotted
#spottedStalking
execute if entity @e[type=armor_stand,tag=stalking] unless entity @e[type=armor_stand,tag=spottedByPlayer] unless entity @s[gamemode=spectator] anchored eyes facing entity @e[type=armor_stand,sort=nearest,limit=1,tag=spread] eyes anchored feet positioned ^ ^ ^1 rotated as @s positioned ^ ^ ^-1 if entity @s[distance=..0.75] at @s anchored eyes facing entity @e[type=armor_stand,sort=nearest,limit=1,tag=spread] eyes positioned ^ ^ ^ run function watching:events/sightings/spotted
