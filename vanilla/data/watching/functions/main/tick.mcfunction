...
execute unless score true startedEvents matches 1.. unless score number dayDelayConfig matches -1 if score day spawnDelay >= number dayDelayConfig run function watching:events/start_events
