...
execute if score true jumpscareConfig matches 1 if score @s crash matches 5 run kill @e[tag=spread,limit=1,sort=nearest]
...
execute if score true jumpscareConfig matches 1 if score true crashConfig matches 1 run title @s times 1 40 1
...
execute if score true jumpscareConfig matches 1 if score true crashConfig matches 1 if score @s crash matches 5 run title @s title {"text":"\uBC04","font":"watching:watching_ui"}
