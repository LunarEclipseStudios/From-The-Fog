...
#summonDoorGhost
summon villager ~ 400 ~ {Silent:1b,Team:"nocol",Age:-699999,Tags:["doorGhost","herobrineEntity"],active_effects:[{id:"minecraft:invisibility",amplifier:1,duration:199999980,show_particles:0b}]}
