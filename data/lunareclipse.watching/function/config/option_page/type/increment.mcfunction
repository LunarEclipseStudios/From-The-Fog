...
# Create the display.
execute positioned ~ ~-0.425 ~ positioned ^1.5 ^ ^ run summon item_display ^ ^ ^ {Tags:["watching.config","watching.settings","watching.display","watching.$(id)"],brightness:{sky:15,block:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.45f,0f],scale:[0.75f,0.75f,0.75f]},item:{id:"minecraft:white_dye",count:1,components:{"minecraft:item_model":"lunareclipse.watching:ui/config/settings/int_display"}}}
# Create the text.
$execute positioned ~ ~-0.425 ~ positioned ^1.5 ^ ^ run summon text_display ~ ~ ~ {Tags:["watching.config","watching.settings","watching.text","watching.display","watching.$(id)"],alignment:"center",line_width:44,brightness:{sky:15,block:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.445f,0f],scale:[0.75f,0.75f,0.75f]},text:{"nbt":"options.$(id)","storage":"lunareclipse.watching:config_options"},background:16711680}

# Create the increase button's hitbox.
execute positioned ~ ~-0.225 ~ positioned ^2.25 ^ ^ run summon interaction ^ ^0.1 ^-0.25 {response:1b,width:0.50f,height:0.50f,Tags:["watching.config","watching.settings","watching.button"]}
$execute positioned ~ ~-0.225 ~ positioned ^2.25 ^ ^ run summon item_display ^ ^ ^ {Tags:["watching.config","watching.settings","watching.button","watching.$(id)"],brightness:{sky:15,block:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.51f,0f],scale:[0.75f,0.75f,0.75f]},item:{id:"minecraft:white_dye",count:1,components:{"minecraft:custom_data":{value:"add", option:"$(id)",function:"lunareclipse.watching:config/option_page/clicked/increment"},"minecraft:item_model":"lunareclipse.watching:ui/config/settings/int_increase"}}}
# Create the decrease button's hitbox.
execute positioned ~ ~-0.225 ~ positioned ^0.80 ^ ^ run summon interaction ^ ^0.1 ^-0.25 {response:1b,width:0.50f,height:0.50f,Tags:["watching.config","watching.settings","watching.button"]}
$execute positioned ~ ~-0.225 ~ positioned ^0.80 ^ ^ run summon item_display ^ ^ ^ {Tags:["watching.config","watching.settings","watching.button","watching.$(id)"],brightness:{sky:15,block:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.51f,0f],scale:[0.75f,0.75f,0.75f]},item:{id:"minecraft:white_dye",count:1,components:{"minecraft:custom_data":{value:"remove", option:"$(id)",function:"lunareclipse.watching:config/option_page/clicked/increment"},"minecraft:item_model":"lunareclipse.watching:ui/config/settings/int_decrease"}}}