...
execute as @e[type=marker,tag=watching.pivot] at @s unless entity @a[tag=watching.opened_config,distance=..6] run function lunareclipse.watching:config/close_config
