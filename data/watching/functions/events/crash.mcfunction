...
execute if score @s crash matches 2 run kill @e[tag=spread,limit=1,sort=nearest]

execute if score @s crash matches 2 run playsound watching:crash master @s ~ ~ ~ 1 1
execute if score @s crash matches 6 run particle ambient_entity_effect ~ ~ ~ 0 0 0 1 666666666 force @s
